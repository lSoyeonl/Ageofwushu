(()=>{
  ...
  const SECTION_KEYS=['neigongs','specialEffects','specialSkills','techniques','reworks'];
  ...
  const azureGuard={
    ...
    detailContent:{
      neigongs:[{
        id:'azure-neigong-1',title:'Нейгун Лазурной Стражи',image:'assets/organizations/factions/azure-guard/neigong.png',
      ...
      specialEffects:[{
        id:'azure-effect-1',title:'Специальные эффекты',image:'assets/organizations/factions/azure-guard/special-skills.png',
      ...
      specialSkills:[{
        id:'azure-special-1',title:'Специальные навыки',image:'assets/organizations/factions/azure-guard/special-skills.png',
        descriptionHtml:'<p>Навыки добавляются отдельными вертикальными блоками: изображение, название и редактируемое описание.</p>'
      }],
      techniques:[{
        id:'azure-technique-1',title:'Приёмы Лазурной Стражи',image:'assets/organizations/factions/azure-guard/skills.png',
        descriptionHtml:'<p>Количество приёмов не ограничено.</p>'
      }],
      reworks:[{
        id:'azure-rework-1',title:'Реворки приёмов',image:'assets/organizations/factions/azure-guard/reworks.png',
